...
```{r example_simultaneous_sequential, eval=FALSE}
...
```{r example_lineup_size, eval=FALSE}
# 6-person lineup
...
```{r example_retention, eval=FALSE}
...
```{r multiple_comparisons, eval=FALSE}
# Three conditions
...
```{r pitfall_bootstrap, eval=FALSE}
