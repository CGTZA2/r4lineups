...
# Three conditions
high_d <- simulate_lineup_data(n_tp = 120, n_ta = 120, d_prime = 2.0, lineup_size = 6)
med_d <- simulate_lineup_data(n_tp = 120, n_ta = 120, d_prime = 1.5, lineup_size = 6)
low_d <- simulate_lineup_data(n_tp = 120, n_ta = 120, d_prime = 1.0, lineup_size = 6)
...
for (i in seq_along(sample_sizes)) {
  ...
  for (sim in 1:50) {
    # Simulate data
    data1 <- simulate_lineup_data(n, n, d_prime = 1.8, lineup_size = 6)
    data2 <- simulate_lineup_data(n, n, d_prime = 1.5, lineup_size = 6)
