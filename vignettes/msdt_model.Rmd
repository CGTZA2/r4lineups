...
filler choices, which are the most diagnostic outcomes. If you have the full
response breakdown (suspect/filler/reject counts for both lineup types),
prefer the likelihood-based fitter `fit_max_sdt()`, which uses all outcome
counts, or the 2-HT model (`fit_winter_2ht()`).
