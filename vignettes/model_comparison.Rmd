...
These methods estimate different quantities; their displayed numbers are not a
common model-selection scale and the wrapper does not declare a “best model.”
...
The 2-HT fit reports AIC/BIC, but these values are comparative rather than
absolute. They can only be compared with alternative likelihood models fitted
to the same observations and outcome representation; they cannot be compared
with EIG or AUC. A single-condition 2-HT fit is saturated.
...
Starns, J. J., Cohen, A. L., & Rotello, C. M. (2023). A complete method for assessing the effectiveness of eyewitness identification procedures: Expected information gain. *Psychological Review, 130*(3), 677–719. https://doi.org/10.1037/rev0000332
