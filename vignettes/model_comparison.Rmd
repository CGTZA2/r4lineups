...
**Interpreting 2-HT parameters:**

- **dP = `r round(model_2ht$parameters["dP"], 2)`**: Probability of detecting guilty suspect
- **dA = `r round(model_2ht$parameters["dA"], 2)`**: Probability of detecting innocent suspect
- **b = `r round(model_2ht$parameters["b"], 2)`**: Bias toward suspect
- **g = `r round(model_2ht$parameters["g"], 2)`**: Tendency to guess vs. reject
...
small_data <- simulate_lineup_data(n_tp = 30, n_ta = 30, d_prime = 1.5)
