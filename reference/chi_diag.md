...
Function for getting chi-squared value for homogeneity of diagnosticity
ratios
...
Chi squared estimate of homogeneity of diagnosticity ratios for k
independent lineups
...
- To compute df, apply ln_diag_ratio, var_lnd & d_weights functions to
  linedf, then bind results into one dataframe (see **Examples**)
...
- The order in which the estimates are bound together (i.e., their
  ...
  follows: row 1: *var*, row 2: *lnd*, row 3: *wi*.
